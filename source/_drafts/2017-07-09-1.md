---
title: iOS不使用SDK实现微信朋友圈分享
date: 2017-07-09 20:12:26
categories: iOS
tags:
copyright: true
---
...
```
//微信朋友圈
+ (NSString *)shareToWechatTimelineParameters:(NSMutableDictionary *)parameters appId:(NSString *)appId onStateChanged:(TStateChangedHandler)stateChangedHandler {
    ...
    if ([TWeChatPlatform isWeChatInstalled]) {
        ...
        if (TPlatformType == TContentTypeText) {
            ...
            NSAssert([parameters urlForParams], @"url 不能为空");
